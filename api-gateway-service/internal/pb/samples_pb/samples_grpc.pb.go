...
type SamplesServiceClient interface {
	...
	GetSampleData(ctx context.Context, in *GetSampleRequest, opts ...grpc.CallOption) (*SampleData, error)
	...
	AddCommentToComment(ctx context.Context, in *Comment, opts ...grpc.CallOption) (*pb.DefaultResponse, error)
...
func (c *samplesServiceClient) GetSampleData(ctx context.Context, in *GetSampleRequest, opts ...grpc.CallOption) (*SampleData, error) {
	out := new(SampleData)
...
func (x *samplesServiceGetSampleFileClient) Recv() (*SampleFile, error) {
	m := new(SampleFile)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (c *samplesServiceClient) AddCommentToComment(ctx context.Context, in *Comment, opts ...grpc.CallOption) (*pb.DefaultResponse, error) {
	out := new(pb.DefaultResponse)
	err := c.cc.Invoke(ctx, "/samples.SamplesService/AddCommentToComment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SamplesServiceServer interface {
	...
	GetSampleData(context.Context, *GetSampleRequest) (*SampleData, error)
	...
	AddCommentToComment(context.Context, *Comment) (*pb.DefaultResponse, error)
...
func (UnimplementedSamplesServiceServer) GetSampleData(context.Context, *GetSampleRequest) (*SampleData, error) {
...
func (UnimplementedSamplesServiceServer) AddCommentToComment(context.Context, *Comment) (*pb.DefaultResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AddCommentToComment not implemented")
}
...
func (x *samplesServiceGetSampleFileServer) Send(m *SampleFile) error {
	return x.ServerStream.SendMsg(m)
}
...
func _SamplesService_AddCommentToComment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Comment)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SamplesServiceServer).AddCommentToComment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/samples.SamplesService/AddCommentToComment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SamplesServiceServer).AddCommentToComment(ctx, req.(*Comment))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SamplesService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AddCommentToComment",
			Handler:    _SamplesService_AddCommentToComment_Handler,
		},
		{
